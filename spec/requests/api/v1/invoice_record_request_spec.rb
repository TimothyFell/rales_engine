...
describe "Invoices Record Endpoints" do
  ...
  describe 'Index and Show Requests' do
    ...
    it "sends the list of all invoices" do
  ...
  describe 'Find Requests' do
    ...
    it "can find a invoice by their customer_id" do
      merch = create(:merchant)
      customer = create(:customer)
    ...
    it "can find a invoice by their merchant_id" do
      merch = create(:merchant)
      customer = create(:customer)
    ...
    it "can find a invoice by their created_at datetime" do
      merch = create(:merchant)
      customer = create(:customer)
    ...
    it "can find a invoice by their updated_at datetime" do
      merch = create(:merchant)
      customer = create(:customer)
  ...
  describe 'Find_all Requests' do
    ...
    it "can find all invoices by an id" do
      merch = create(:merchant)
      customer = create(:customer)
    ...
    it "can find all invoices by a customer_id" do
      merch = create(:merchant)
      customer = create(:customer)
    ...
    it "can find all invoices by a merchant_id" do
      merch = create(:merchant)
      customer = create(:customer)
